...
class CreateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'fire'), createEmptyInstance: create)
    ...
    ..pc<Log>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logs', $pb.PbFieldType.PM, subBuilder: Log.create)
    ..pc<Weather>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'weathers', $pb.PbFieldType.PM, subBuilder: Weather.create)
  ...
  @$pb.TagNumber(9)
  $core.List<Log> get logs => $_getList(8);

  @$pb.TagNumber(10)
  $core.List<Weather> get weathers => $_getList(9);
}
